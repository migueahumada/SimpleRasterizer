...
namespace MKEngine {
	...
	MKGraphicsAPI::MKGraphicsAPI(void* pHwnd) : m_pHwnd(pHwnd)
	{
	}

	MKGraphicsAPI::~MKGraphicsAPI()
	{
	}
	...
	void MKGraphicsAPI::OnStartUp()
	{
		...
		HWND hwnd = static_cast<HWND>(m_pHwnd);
	...
	void MKGraphicsAPI::QueryInterfaces(int width, int height)
	{
		if (!m_pSwapChain)
		{
			return;
	...
	ID3D11Texture2D* MKGraphicsAPI::CreateTexture(int width,
		int height,
		DXGI_FORMAT format,
		D3D11_USAGE usage,
		UINT bindFlags,
	...
	SPtr<VertexShader> MKGraphicsAPI::CreateVertexShader(const Path& filePath, const String& entryFunction)
	{
	...
	SPtr<PixelShader> MKGraphicsAPI::CreatePixelShader(const Path& filePath, const String& entryFunction)
	{
	...
	ID3D11InputLayout* MKGraphicsAPI::CreateInputLayout(Vector<D3D11_INPUT_ELEMENT_DESC> pInputElementDesc,
	...
	SPtr<GraphicsBuffer> MKGraphicsAPI::CreateVertexBuffer(const Vector<char>& data)
	{
	...
	SPtr<GraphicsBuffer> MKGraphicsAPI::CreateIndexBuffer(const Vector<char>& data)
	{
	...
	SPtr<GraphicsBuffer> MKGraphicsAPI::CreateConstantBuffer(const Vector<char>& data)
	{
	...
	void MKGraphicsAPI::writeToBuffer(const WPtr<GraphicsBuffer>& pBuffer, const Vector<char>& data)
	{
